    ...
    public partial class initMIG : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemsUnits", x => x.ItemUnitID);
                    table.ForeignKey(
                        name: "FK_ItemsUnits_Products_ProductID",
                        column: x => x.ProductID,
                        principalTable: "Products",
                        principalColumn: "ProductID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ItemsUnits_Units_UnitID1",
                        column: x => x.UnitID1,
                        principalTable: "Units",
                        principalColumn: "UnitID");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShoppingCartItems_AspNetUsers_BuyerID",
                        column: x => x.BuyerID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Shippings_Zones_ZoneID1",
                        column: x => x.ZoneID1,
                        principalTable: "Zones",
                        principalColumn: "ZoneID");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItemsUnits_ProductID",
                table: "ItemsUnits",
                column: "ProductID");

            migrationBuilder.CreateIndex(
                name: "IX_ItemsUnits_UnitID",
                table: "ItemsUnits",
                column: "UnitID");

            migrationBuilder.CreateIndex(
                name: "IX_ItemsUnits_UnitID1",
                table: "ItemsUnits",
                column: "UnitID1");
